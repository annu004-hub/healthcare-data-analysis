...
q2 = run_query("""
    ...
    LIMIT 20
""")
q2.to_csv("powerbi_data/02_mortality_by_diagnosis.csv", index=False)
...
""")
q3.to_csv("powerbi_data/03_monthly_trends.csv", index=False)
...
q4 = run_query("""
    ...
    GROUP BY insurance
""")
q4.to_csv("powerbi_data/04_insurance_analytics.csv", index=False)
...
q5 = run_query("""
    ...
    LIMIT 30
""")
q5.to_csv("powerbi_data/05_lab_analytics.csv", index=False)
...
""")
q6.to_csv("powerbi_data/06_admission_type.csv", index=False)
...
q8 = run_query("""
    ...
    GROUP BY los_bucket
""")
q8.to_csv("powerbi_data/08_los_distribution.csv", index=False)
print("8. LOS distribution exported!")

print("\nAll 8 files exported to powerbi_data folder!")